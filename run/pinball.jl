...
# Define grid
nx = 1500  # num of x points on finest domain
ny = 750  # num of y points on finest domain (length in y-dirn is len/m * n )
mg = 5   # num domains
len = 20.0  # length of domain in x-direction
offx = 5.0; # offset in x dirn (on fine domain, x-grid runs from -offx to len-offx.
offy = 5.0; # offset in y dirn (same as offx but in y-dirn)
